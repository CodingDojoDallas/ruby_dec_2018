...
## Setup
 ...
 3. Create a folder with your name (firstname_lastname)
 4. Add *this* (https://github.com/CodingDojoDallas/ruby_dec_2018/) repo as a REMOTE to your locally cloned copy.
```
git remote add upstream https://github.com/codingdojodallas/ruby_dec_2018
```
 5. Profit!
# Daily Commits
